...
```{r}
geog_scale_precision <- as.data.frame(table(fossils$geogscale))
sum(is.na(fossils$geogscale))
geog_scale_precision[nrow(geog_scale_precision) + 1,] = c("Range_UNSPECIFIED","456")

ggplot(geog_scale_precision, aes(x = Var1, y= Freq)) +
  geom_bar() +
  labs(x = "Geographic scale",
       y = "Frequency")
